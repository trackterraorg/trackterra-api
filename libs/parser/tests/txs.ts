export const txHashes = {
  ...
  anchor: [
    ...
    },
    {
      label: 'bluna mint',
      txHash:
        'B26F19E8BF2821FA81185F16442E2FF747B347E6A9D9E4FB50DAF50908A387FC',
      walletAddress: 'terra1ucxftqm3hx6kxq9den984lypuwdq3uknft4kla',
    },
    {
      label: 'bluna claim rewards',
      txHash:
        '97074D267804C27142BB0A0F373B7C8CCE0A66777933353817E540B718F72299',
      walletAddress: 'terra1k2mvkjph7mjutr5h807uy6jamczukkyctr8c6q',
    },
    {
      label: 'bluna borrow',
      txHash:
        'CC6E924D217B718BC760915D03E8882A22124C66451C2A8B80D58D8F86C8D320',
      walletAddress: 'terra1097hd9x9w9ffm2qer5tmugfd6r4g6ku6yapra7',
    },
    {
      label: 'lp claim rewards',
      txHash:
        '22583084242A1C4EB2F7276B40465E370AE21864452781FF3D98C1E8335824AC',
      walletAddress: 'terra1tmlvtdnxwpzl59scfh3z55rwcfvdupy39ahhkp',
    },
    {
      label: 'lp withdraw staking',
      txHash:
        'BD4C65FDB03EBA5827D4281EDE7F43894D122F59D087C08DC93F1C41A9875C6C',
      walletAddress: 'terra1fx85ce8r4ydhmu4wcaydf9fcf98j22lf0s7fwu',
    },

    {
      label: 'deposit collateral',
      txHash:
        'A0D26EC839739C2AED90E66B1F08D092B107B50C416C3E1311C86DCA2C2D6309',
      walletAddress: 'terra1m5qyq4xuf5ln7ek39uedlef48trfjqqle3cqdj',
    },
    {
      label: 'withdraw collateral',
      txHash:
        '6583B1C65F6D824CF53C3C5C5755B587B683D7D84FD99E97569BF0B9CAE464A0',
      walletAddress: 'terra1dm2m07pnk9mwdgukw6tycefh955d8nnpzucsv4',
    },
    {
      label: 'repay stable',
      txHash:
        'B11A4C468DAB87F04FD0905A9A959EB14F425D0E687023BA7F7334A83427CEA8',
      walletAddress: 'terra1zzxajypxfzzcrn0yt8m2wpdvygfxstkupl59vl',
    },
    {
      label: 'aust mint',
      txHash:
        'FC67774AFAA0B907728A00E4E060AC7292E471C22CE9D41D30A7E91900612E09',
      walletAddress: 'terra1cwa2mm9tmmm3uxkqqa50lfmzmeap9a24j30nml',
    },
    {
      label: 'aust redeem',
      txHash:
        '266A350A377C1F1B2C86B2D8FD0130D461BF723410732B9B3BCF7C2795AE93F3',
      walletAddress: 'terra1selhr9ekvylll4ana76vmdamelps4ds52twx6f',
    },
    {
      label: 'aust mint',
      txHash:
        '16D1BA1870A42F07F298C0A2D810AA3E2D8162312D692B6BD902A99A5377BC63',
      walletAddress: 'terra1selhr9ekvylll4ana76vmdamelps4ds52twx6f',
    },
    {
      label: 'bluna mint',
      txHash:
        'AB870CF29B6C11AC52A4440A6CDA857426F2F8BF181DF072CD49EE42F81DC1EB',
      walletAddress: 'terra1selhr9ekvylll4ana76vmdamelps4ds52twx6f',
    },
    {
      label: 'anchor governance deposit',
      txHash:
        '6F417F5BED662C58F26414B896CAE65D8A38488E0626CE65655F58C8D9415187',
      walletAddress: 'terra1selhr9ekvylll4ana76vmdamelps4ds52twx6f',
    },
    {
      label: 'anchor governance withdraw',
      txHash:
        'C3C3680252A117636E7728751E390692B00DF4F7F0FDED9F94501A3B8416F068',
      walletAddress: 'terra1selhr9ekvylll4ana76vmdamelps4ds52twx6f',
    },
    {
      label: 'liquidation retract bid',
      txHash:
        '611ACCC6FF0B8BD84709DFD2F29BD7EDF89C8FEBAD13AB6F980DFC5BECBA906D',
      walletAddress: 'terra1lpk4agfr08llhxzt0fen8ddk3pryxjhvasyduw',
    },
    {
      label: 'liquidation place bid',
      txHash:
        'EF5A193EDA6C3BDFB9BB29F10A4D84BFA3E7B3027BBC1199DA2C0D981F2D0686',
      walletAddress: 'terra1lpk4agfr08llhxzt0fen8ddk3pryxjhvasyduw',
    },
    {
      label: 'claim liquidation',
      txHash:
        '769FF48863DC9C76CA29969874B48350A671B4EFD99FB5998C2C87A16D1D0DEC',
      walletAddress: 'terra1lpk4agfr08llhxzt0fen8ddk3pryxjhvasyduw',
    },
    {
      label: 'anchor liquidation',
      txHash:
        '6A03636270426EAED436AE234D9C8F438EB19C248976011DD18A5AFF551AE776',
      walletAddress: 'terra1prn5gmevtp48thl3pahx09s3dpkgucl7vw0f04',
    },
    {
      label: 'Anchor provide liquidity',
      txHash:
        '98C163732345749C9AA68DA131A36E8C304E7F9B0FD8528B6EF0783D28E10179',
      walletAddress: 'terra1mlsy8crn05w957y99ytcq8srxsq54xd47kcmzk',
    },
    {
  ...
  mirror: [
    ...
    {
      label: 'position open short farm',
      txHash:
        '278227065E845906CC9F04C9A0474C3621D50911D8ACC699DC3DC654CCEE93EA',
      walletAddress: 'terra1selhr9ekvylll4ana76vmdamelps4ds52twx6f',
    },
    {
      label: 'claim rewards',
      txHash:
        '3ED62397D015E467DE68338F6D76C66F355430E822D636B3023640646208E4E3',
      walletAddress: 'terra1m3jg6rdylqnpwtuv6hs034n662w57qyzen6t6s',
    },
    {
      label: 'auto staking',
  ...
  nexus: [
    {
      label: 'deposit nexus vaault eth',
      txHash:
        '1084AD2D06A1FE9ADC6BB6F71787F54CB1E1D6B8C999120969AF4876E79EBF53',
      walletAddress: 'terra1selhr9ekvylll4ana76vmdamelps4ds52twx6f',
    },
    {
      label: 'deposit nexus vaault eth',
      txHash:
        '8E0B15AEF629F245D7DD2AA24771D6CA7C553811E3EE4F9F6EEBC818DC103125',
      walletAddress: 'terra1selhr9ekvylll4ana76vmdamelps4ds52twx6f',
    },
    {
      label: 'Nexus pool deposit',
      txHash:
        '62C2828E7C4A6C57299DEF27EDDC852D3B0F069DD50C04F45E686F5097C077DC',
      walletAddress: 'terra1selhr9ekvylll4ana76vmdamelps4ds52twx6f',
    },
    {
      label: 'Nexus pool withdraw',
      txHash:
  ...
  apollo: [
    ...
    {
      label: 'ApolloDAO UnStake LP',
      txHash:
        '4CD5F6B6A7AF9E666A9650B876AF9E9F5D2001FFBAF7EA2CA9490E429AE66016',
      walletAddress: 'terra1selhr9ekvylll4ana76vmdamelps4ds52twx6f',
    },
    {
      label: 'ApolloDAO Stake LP',
      txHash:
        'AF1FC738E335EBE4E6959612BCDF86269DE403455A30E316A5130025B0E57FFD',
      walletAddress: 'terra1selhr9ekvylll4ana76vmdamelps4ds52twx6f',
    },
    {
      label: 'ApolloDAO Stake LP',
      txHash:
        '2D644D893A1A546C5ACD70D9A7BC2926BFB04EBE0F4E22B41D9B4776A27F0830',
      walletAddress: 'terra1selhr9ekvylll4ana76vmdamelps4ds52twx6f',
    },
  ],
  pylon: [
    {
      label: 'Pylon Goverance Staking',
      txHash:
        '48CD1633F5BA965B81E18BE0278381098C9B804BB321111F134155D2F0203B5C',
      walletAddress: 'terra1selhr9ekvylll4ana76vmdamelps4ds52twx6f',
    },
    {
      label: 'Pylon Goverance Staking',
      txHash:
        '2219497AAD9C966063C0B38528E232176FC414AE1F5498A756331C27A29AAA99',
      walletAddress: 'terra1selhr9ekvylll4ana76vmdamelps4ds52twx6f',
    },
    {
      label: 'Pylon Goverance Staking',
      txHash:
        'EC7A6D99FE17FCEDE1EA5DBAD9A9BB8ACEE258B5EBDC7BF1EDC6CCB812E8DC63',
      walletAddress: 'terra1selhr9ekvylll4ana76vmdamelps4ds52twx6f',
    },
    {
      label: 'Pylon pool deposit',
      txHash:
        'EAECE7CDFF725111A5ED2FE6DEA9A40E73AB58EB6818A2BB8254E9FF21ACEAD8',
      walletAddress: 'terra1selhr9ekvylll4ana76vmdamelps4ds52twx6f',
    },
    {
  ...
  loterra: [
    {
      label: 'Lottera deposit',
      txHash:
        'D8F73DCCEC8628D258461D5F2E37FE396A46AD17F3475AEEDB7D1BDC472052AE',
      walletAddress: 'terra1tx2u8pydjpzvnfhv0mezr9xykk2y9tys0a3ptr',
    },
    {
      label: 'Lottera deposit',
      txHash:
        '8D64F9DA0F57E2D7910F088AD2E005B75E97FFA2E7F8181C22E5478263146B0F',
      walletAddress: 'terra1lemert7mf0updhrgjpe9v6rv9wplcv6m0t9j7s',
    },
  ],
  spec: [
    {
      label: 'Goverance Staking',
      txHash:
        '0BDD65822B42ADABDF7DA961CCDBF664FDACEA14ECB0FD60403B67E8EA17B4B3',
      walletAddress: 'terra1p2ptfvmda4anhp68s80xlna6uekpwfqud73j4h',
    },
    {
      label: 'Claim Goverance Rewards',
      txHash:
        '24D3187940254534412AE5B7DB644563D1A36AF781A17D1ADA3519B18096D77F',
      walletAddress: 'terra1j8d8w7v57kf7j50yn9n00gt6a2nzh7x2vlnq53',
    },
    {
      label: 'Goverance UnStaking',
      txHash:
